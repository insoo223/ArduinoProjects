...
public:
	...
	//Followings are added by Insoo (May23, 2019)
	void setupDS1307 (); 
	void dispTimeDS1307_Serial(); 
	void dispYYYYMMDD_Mdigit7Seg(trippleX* X, Four7segX* _7X);
	void dispHHMM_Mdigit7Seg(trippleX* X, Four7segX* _7X);
	void setTimeDS1307(int year, byte month, byte dayOfMonth, byte hour, byte minute, byte second);
private:
	//Insoo added (May23, 2019)
	char _daysOfTheWeek[7][4] = {"SUN", "MON", "TUE", "WED", "THU", "FRI", "SAT"}; 
};
